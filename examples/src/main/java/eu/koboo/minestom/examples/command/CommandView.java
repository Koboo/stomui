package eu.koboo.minestom.examples.command;
...
import eu.koboo.minestom.examples.views.AllowInteractionExampleProvider;
import eu.koboo.minestom.examples.views.AnnotatedTabExampleProvider;
import eu.koboo.minestom.examples.views.AnvilInputExampleProvider;
import eu.koboo.minestom.examples.views.pagination.PageableExampleProvider;
import eu.koboo.minestom.examples.views.pagination.ScrollableHorizontalExampleProvider;
import eu.koboo.minestom.examples.views.pagination.ScrollableVerticalExampleProvider;
import eu.koboo.minestom.examples.views.search.SearchExampleProvider;
import eu.koboo.minestom.examples.views.switching.MultiLayersExampleProvider;
import eu.koboo.minestom.examples.views.switching.SwitchOneExampleProvider;
